 ...
 */
#ifndef MLPACK_CORE_TREE_BINARY_SPACE_TREE_MIDPOINT_SEGMENT_SPLIT_IMPL_HPP
#define MLPACK_CORE_TREE_BINARY_SPACE_TREE_MIDPOINT_SEGMENT_SPLIT_IMPL_HPP
...
bool MidpointSegmentSplit<BoundType, MatType>::SplitNode(const BoundType& bound,
        MatType & data,
        SplitInfo& splitInfo)
{
    double maxWidth = -1;
